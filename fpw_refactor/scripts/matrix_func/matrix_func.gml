...
// TODO: optimize all of these matrix creation functions
// to use array_create, then set values
// actually.. just see if array_create is
// faster than var arr = [1, 2, 3] ect????
...
// keep this around for now, for backwards compatability im not
// too sure how to solve yet
_G.matrix_general_stack = ds_stack_create();

///@arg matrix
function matrix_general_push (mat)
{
	ds_stack_push(_G.matrix_general_stack, mat);
}


function matrix_general_pop ()
{
	if (!ds_stack_empty(_G.matrix_general_stack))
	{
		return ds_stack_pop(_G.matrix_general_stack);
	}
