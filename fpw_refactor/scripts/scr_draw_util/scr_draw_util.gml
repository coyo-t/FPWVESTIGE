...
function buffer2sprite (bff, offset, w, h)
{
	var srf = surface_create(w, h);
	buffer_set_surface(bff, srf, offset);
		
	var spr = sprite_create_from_surface(srf, 0, 0, w, h, false, false, 0, 0);
	surface_free(srf);
